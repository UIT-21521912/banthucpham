       ...
       <div class="banner">
    <div class="img">
        <img src="public/img/banner.png" class="img-fluid" alt="">
    </div>
</div>
<!-- search -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7836.432415333844!2d106.80343948150639!3d10.871153575503369!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317527587e9ad5bf%3A0xafa66f9c8be3c91!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBDw7RuZyBuZ2jhu4cgVGjDtG5nIHRpbiAtIMSQSFFHIFRQLkhDTQ!5e0!3m2!1svi!2sus!4v1703868467622!5m2!1svi!2sus" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                </div>
            </div>
        ...
        <div class="row jc-sb">
            ...
            <div class="col-md-12 col-lg-7 md-pb my-auto">
                <div class="media-content">
                    ...
                    <div class="mbr-section-btn align-left"><a class="btn btn-md btn-black display-4" href="http://localhost:8080/banthucpham/home">
                        <span ><ion-icon name="logo-google-playstore"></ion-icon></span>Get it on<br>Google
                            Play<br>
                        </a> <a class="btn btn-md btn-black display-4" href="http://localhost:8080/banthucpham/home">
